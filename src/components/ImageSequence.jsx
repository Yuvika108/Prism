...
export default function ImageSequence() {
    return (
        <div className="fixed inset-0 z-0 bg-[#040d09] flex items-center justify-center overflow-hidden">
            <div className="relative w-full h-full max-w-6xl max-h-[80vh] flex items-center justify-center animate-float-slow scale-105">

                {/* Final Static Image - Always visible background element */}
                <img
                    src="/Whisk_f4c7122c7af4d578d0245026c0e325d8dr.png"
                    alt="PRISM Logo"
                    className="absolute inset-0 w-full h-full object-contain opacity-40 transition-opacity duration-[2000ms]"
                />
